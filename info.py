...
BOT_TOKEN = environ.get('BOT_TOKEN', "8154916148:AAGdtK_iCBedLZ3VFoguJ1uwguopW50FJDs")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://sakthiraj940:vFGkAQL9n@mR9!4@cluster0.h75s7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'file_channel_pro') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_bot_discussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tn_bots')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'oungal_nanban_bot') # Support Chat Link Without https:// or @
